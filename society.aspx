...
<form>
   ...
   <ul class="nav navbar-nav" style="position:absolute";>
    ...
    <div class="row">
        <hr />
        <div id="arrow" class="col-xs-12 col-sm-12"><a href="./Default.aspx">首頁</a>＞<a href="./logbook.aspx">品牌記事</a>＞<a href="./society.aspx">社會議題</a><hr /></div>
        ...
        <div id="sideheading" class="col-xs-12 col-sm-10">
            <div class="col-xs-12 col-sm-5"><a href="#"><img src="./images/about01.png" /></a><div class="showtitle">檔案1</div></div>
            <div class="col-xs-12 col-sm-5"><a href="#"><img src="./images/about02.png" /></a><div class="showtitle">檔案2</div></div>
            <div class="col-xs-12 col-sm-5"><a href="#"><img src="./images/about03.png" /></a><div class="showtitle">檔案3</div></div>
        </div>
    </div>
