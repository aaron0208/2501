<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trademark.aspx.cs" Inherits="trademark" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>2501相關品牌</title>
...
<form>
   ...
   <ul class="nav navbar-nav" style="position:absolute";>
    ...
    <div class="row">
        <hr />
        <div id="arrow" class="col-xs-12 col-sm-12"><a href="./Default.aspx">首頁</a>＞<a href="./logbook.aspx">品牌記事</a>＞<a href="./trademark.aspx">品牌合作</a></div><hr />
