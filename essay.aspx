...
<form></form>
   ...
   <ul class="nav navbar-nav" style="position:absolute";>
    ...
    <div class="row">
        ...
        <div id="daily" class="col-xs-12 col-sm-10">
            <div id="blockquote"><img src="./images/about01.png" /></div>
            <div id="example">背織帶的意義
                <p>台灣工廠製造２０支精梳棉<br />
                選圖還有印刷<br />
                所有成色方面我們用的技術是最新最好的<br />
                背織帶的意義<br />
                就代表每件衣服都是我們自己打板生產製作<br />
                絕對不是工廠不要的尾貨拿來濫竽稱數</p>
            </div>
        </div>
    </div>
