<%@ Page Language="C#" AutoEventWireup="true" CodeFile="charitable_event.aspx.cs" Inherits="charitable_event" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>2501公益責任</title>
...
<form>
   ...
   <ul class="nav navbar-nav" style="position:absolute";>
    ...
    <div class="row">
        <hr />
        <div id="arrow" class="col-xs-12 col-sm-12"><a href="./Default.aspx">首頁</a>＞<a href="./logbook.aspx">品牌記事</a>＞<a href="./charitable_event.aspx">公益責任</a><hr /></div>
        <div id="subtitle" class="col-xs-12 col-sm-2">
            <ul style="list-style-type:none;line-height:36px">
                <li><a href="./history.aspx">品牌記事</a></li>
                <li><a href="./Media.aspx">媒體曝光</a></li>
                <li><a href="./society.aspx">社會議題</a></li>
                <li><a href="./charitable_event.aspx">公益責任</a></li>
            </ul>
        </div>
            <div id="sideheading" class="col-xs-12 col-sm-10">
                <div id="show" class="col-xs-12 col-sm-5" ><a href="#"><img src="./images/about01.png" /></a>
                    <div class="showtitle">創辦起源</div></div>
                <div id="show" class="col-xs-12 col-sm-5" ><a href="#"><img src="./images/about02.png" /></a>
                    <div class="showtitle">創辦起源</div></div>
                <div id="show" class="col-xs-12 col-sm-5" ><a href="#"><img src="./images/about03.png" /></a>
                    <div class="showtitle">創辦起源</div></div>
            </div>
    </div>
