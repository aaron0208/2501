<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trolley.aspx.cs" Inherits="trolley" %>
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <div id="arrow" class="col-xs-12 col-sm-12"><a href="./guestproduct.aspx">購物首頁</a>＞<a href="./payfor.aspx">購物車</a>＞<a href="./alternative.aspx">付費方式</a>＞<a href="./trolley.aspx">填寫資料</a>
            <div id="substance">填寫送件資料
                <div id="fill">
                    <div class="form-group">
                        <label for="ID">收件人信箱</label>
                        <input type="email" class="form-control" id="ID" placeholder="輸入您的電子信箱">
                    </div>
                    <div class="form-group">
                        <label for="name">收件人大名</label>
                        <input type="name" class="form-control" id="name" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="country">欲配送國家</label>
                        <input type="text" class="form-control" id="country" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="address">詳細地址</label>
                        <input type="text" class="form-control" id="address" placeholder="請輸入送件地址" style="height: 36px;">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="remarknote">留言</label>
                        <input type="text" class="form-control" id="remarknote" placeholder="">
                    </div>
                    <!-- /// -->
