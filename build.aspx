<%@ Page Language="C#" AutoEventWireup="true" CodeFile="build.aspx.cs" Inherits="build" %>
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <div id="substance">填寫資料
                <div id="fill">
                    <div class="form-group">
                        <label for="ID">填寫帳號</label>
                        <input type="email" class="form-control" id="ID" placeholder="輸入您的電子信箱">
                    </div>
                    <div class="form-group">
                        <label for="password">請輸入密碼</label>
                        <input type="password" class="form-control" id="password" placeholder="切勿填入符號">
                    </div>
                    <div class="form-group">
                        <label for="checkpw">再次確認密碼</label>
                        <input type="password" class="form-control" id="chwckpw" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="birthday">輸入您的生日</label>
                        <input type="text" class="form-control" id="birthday" placeholder="yy/mm/dd">
                    </div>
                    <div class="form-group">
                        <label for="name">購買人大名</label>
                    ...
                    <div class="form-group">
                        <label for="question">忘記密碼通關問題</label>
                        <input type="text" class="form-control" id="question" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="anwser">答案</label>
                        <input type="text" class="form-control" id="anwser" placeholder="">
                    </div>
                    <!-- /login -->
                    <ul style="padding-left:14px">
                        <ol>
                            <li>本公司絕不濫發廣告信，請務必填寫正確資料，方便送貨人員通知取貨。</li>
                            <li>會員資料可在實體店面銷費時提出，累積優惠。</li>
                            <li>請隨時注意官網發布的最新會員權益。</li>
                        </ol>
                    </ul>
                </div>
                <div>
                    <ul>
                        <li style="list-style-type:none;font-size:18px;text-align:center;letter-spacing:2px">
                            <label>
                                <input name="agree" type="checkbox" value="0" />已了解上述說明並同意</label>
                        </li>
                        <li style="list-style-type:none;text-align: center;">
                            <a href="./default.aspx"><img src="./images/join_07.png">
                            </a>
                        </li>
                    </ul>
                </div>
