<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cooperate.aspx.cs" Inherits="cooperate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>2501創辦人合作</title>
...
<form>
   ...
   <ul class="nav navbar-nav" style="position:absolute";>
    ...
    <div class="row">
        <hr />
        <div id="arrow" class="col-xs-12 col-sm-12"><a href="./Default.aspx">首頁</a>＞<a href="./logbook.aspx">品牌記事</a><hr /></div>
        <div id="subtitle" class="col-xs-12 col-sm-2">
            <ul style="list-style-type:none;line-height:36px">
                <li><a href="./director.aspx">導演</a></li>
                <li><a href="./music.aspx">音樂</a></li>
                <li><a href="./designer.aspx">插畫</a></li>
                <li><a href="./trademark.aspx">品牌</a></li>
            </ul>
        </div>
             <div id="sideheading" class="col-xs-12 col-sm-10">
                <div id="show" class="col-xs-12 col-sm-5" ><a href="./director.aspx"><img src="./images/about01.png" /></a>
                    <div class="showtitle">導演</div></div>
                <div id="show" class="col-xs-12 col-sm-5" ><a href="./music.aspx"><img src="./images/about02.png" /></a>
                    <div class="showtitle">音樂</div></div>
                <div id="show" class="col-xs-12 col-sm-5" ><a href="./designer.aspx"><img src="./images/about03.png" /></a>
                    <div class="showtitle">插畫</div></div>
                <div id="show" class="col-xs-12 col-sm-5" ><a href="./trademark.aspx"><img src="./images/about03.png" /></a>
                    <div class="showtitle">品牌</div></div>
            </div>
    </div>
