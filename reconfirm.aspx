<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reconfirm.aspx.cs" Inherits="reconfirm" %>
    ...
    <head runat="server">
        ...
        <link rel="stylesheet" type="text/css" href="./css/reconfirm.css" />
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <div class="row">
            <div id="arrow" class="col-xs-12 col-sm-12">
                <a href="./guestproduct.aspx">購物首頁</a>＞
                <a href="./payfor.aspx">購物車</a>＞
                <a href="./alternative.aspx">付費方式</a>＞
                <a href="./trolley.aspx">填寫資料</a>＞
                <a href="./reconfirm.aspx">再次確認</a>
            </div>
            </div>
            <div id="inner">
                <div id="reconfirm" class="data">
                    <div id="a">訂購人：<span id="name">陳郁翔</span></div>
                    <div id="b">收件人：<span id="recipient">田瑞祥</span></div>
                    <div id="c">收件地址：<span id="country">台灣省</span><span id="address">新北市中和區員山路504號4樓之9</span></div>
                    <div id="d">電話號碼：<span id="number">+886-912345678</span></div>
                    <div id="e">備註：<span id="remarknote"></span></div>
                    <div id="f">總額：<span id="total"></span></div>
                    <div id="g">付款方式：<span id="payment"></span></div>
                </div>
                <div id="agree" class="data">
	                ...
	                <div class="joinContent">
                        ...
                        <div class="joinLine">
                            <div id="joinLineInside">
                                ...
                                <a href="./signup.aspx"><div class="mainBtn" onclick="login()">加入</div> </a>
                            </div>
                        </div>
