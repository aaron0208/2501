<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wishes.aspx.cs" Inherits="wishes" %>
    ...
    <form>
        ...
        <div class="row">
            <hr />
            <div id="arrow" class="col-xs-12 col-sm-12"><a href="./Default.aspx">首頁</a>＞<a href="./logbook.aspx">品牌記事</a>＞<a href="./wishes.aspx">品牌願景</a>
            <hr />
            </div>
            <div id="subtitle" class="col-xs-12 col-sm-2">
                <ul style="list-style-type:none;line-height:36px">
                    <li><a href="./history.aspx">品牌故事</a>
                    </li>
                    <li><a href="./Media.aspx">媒體曝光</a>
                    </li>
                    <li><a href="./society.aspx">社會議題</a>
                    </li>
                    <li><a href="./charitable_event.aspx">公益責任</a>
                    </li>
                </ul>
            </div>
