<%@ Page Language="C#" AutoEventWireup="true" CodeFile="payfor.aspx.cs" Inherits="payfor" %>
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <div class="row">
                <hr />
                <div id="arrow" class="col-xs-12 col-sm-12"><a href="./guestproduct.aspx">購物首頁</a>＞<a href="./payfor.aspx">購物車</a>
                </div>
            </div>
            <div class="row">
                <div id="itemHead" class="hidden-xs col-sm-12">
                    <div id="Div1" class="col-xs-6 col-sm-3"> 
                    </div>
                    <div id="narrting" class="col-xs-6 col-sm-2">商品名稱  
                    </div>
                    <div id="quantity" class="col-xs-6 col-sm-3">數量
                    </div>
                    <div id="color" class="col-xs-6 col-sm-2">顏色
                    </div>
                    <div id="price" class="col-xs-6 col-sm-2">價格
                    </div>
                </div>
            </div>
            <div class="row" id="itemBody" >
                <div id="scr" class="col-xs-12 col-sm-3">
                    <img src="./images/buyonloneimg-1.png" />
                </div>
                <div id="txt" class="col-xs-12 col-sm-2">
                    <span id="name">12345678</span>
                    <p>123123123123</p>
                </div>
                <div id="quan" class="col-xs-12 col-sm-3">
                    <div id="amount" class="col-xs-12 col-sm-12">
                        <span id="quantum">50</span>件
                    </div>
                    <div id="del" class="col-xs-12 col-sm-12">
                        <button type="button">取消</button>
                    </div>
                </div>
                <div id="kind" class="col-xs-12 col-sm-2">
                    <span id="variety">白色</span>
                </div>
                <div id="cash" class="col-xs-12 col-sm-2">
                    TWD.<span id="revenue">480</span>
                </div>
                
            </div>
            <div class="row">
                <hr />
                <div id="total" class="col-xs-12 col-sm-1">
                    <p>商品金額:TWD.</p><br />
                    <p>購物金:TWD.</p><br />
                    <p>折扣:TWD.</p><br />
                    <p><span id="all">總價:TWD.</span></p>
                </div>
                <div id="decide" class="col-xs-12 col-sm-12">
                    <div id="backtrolley" class="col-xs-12 col-sm-6"><a href="#" a style="color:#FFF;linkcolor:#FFF;visited-color:#FFF;hover-color:#FFF;text-decoration:none" onClick="history.back()" >返回購物頁面</a></div>
                    <div id="pay" class="col-xs-12 col-sm-6" ><a href="./alternative.aspx" a style="color:#FFF;linkcolor:#FFF;visited-color:#FFF;hover-color:#FFF;text-decoration:none">可以結帳了</a></div>
                </div>
            </div>
