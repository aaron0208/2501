<%@ Page Language="C#" AutoEventWireup="true" CodeFile="exposure.aspx.cs" Inherits="exposure" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
         <title>2501曝光活動</title>
    ...
    <body>
        ...
        <div class="row">
            <hr />
            <div id="arrow" class="col-xs-12 col-sm-12"><a href="./Default.aspx">首頁</a>＞<a href="./news.aspx">最新消息</a>＞<a href="./exposure.aspx">媒體曝光</a>
            <hr />
            </div>
