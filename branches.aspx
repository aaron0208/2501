<%@ Page Language="C#" AutoEventWireup="true" CodeFile="branches.aspx.cs" Inherits="branches" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>2501加盟資訊</title>
    ...
    <form>
        ...
        <div class="row">
            <hr />
            <div id="arrow" class="col-xs-12 col-sm-12"><a href="./Default.aspx">首頁</a>＞<a href="./alliance.aspx">店鋪加盟</a>＞<a href="./branches.aspx">加盟資訊</a>
            <hr />
            </div>
            <div id="subtitle" class="col-xs-12 col-sm-2">
                <ul style="list-style-type:none;line-height:36px">
                    <li><a href="./franchise.aspx">分店資訊</a>
                    </li>
                    <li><a href="./branches.aspx">加盟資訊</a>
                    </li>
                </ul>
            </div>
            <div id="sideheading" class="col-xs-12 col-sm-10">
                <div id="show" class="col-xs-12 col-sm-5" ><a href="#"><img src="./images/about01.png" style="margin-top: 0px;"/></a>
                    <div class="showtitle">展店一</div></div>
                <div id="show" class="col-xs-12 col-sm-5" ><a href="#"><img src="./images/about02.png" style="margin-top: 0px;"/></a>
                    <div class="showtitle">展店二</div></div>
