<%@ Page Language="C#" AutoEventWireup="true" CodeFile="art_activity.aspx.cs" Inherits="art_activity" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
        <title>2501藝術活動</title>
 ...
 <div class="row">
            <hr />
            <div id="arrow" class="col-xs-12 col-sm-12"><a href="./Default.aspx">首頁</a>＞<a href="./news.aspx">最新消息</a>＞<a href="./art_activity.aspx">藝術活動</a>
            <hr />
            </div>
