        ...
        "<div class='container'>" +
            ...
            "<div class='collapse navbar-collapse' id='bs-example-navbar-collapse-1'>" +
                "<ul class='nav navbar-nav'>" +
                    "<li><a href='#contact'>最新消息</a>" +
                    "</li>" +
                    "<li><a href='./product.aspx'>線上購物</a></li>" +
                    "<li><a href='#contact'>消費須知</a>" +
                    "</li>" +
                    "<li><a href='#services'>品牌記事</a>" +
                    "</li>" +
                    "<li><a href='#contact'>店鋪加盟</a>" +
                    "</li>" +
                    "<li><a href='#contact'>創辦人合作</a>" +
                    "</li>" +
