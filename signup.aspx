    ...
    <body>
                            ...
                            <div class="form-horizontal">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <img id="validateJpg" alt="" src="./SentValidate.ashx" title="點擊圖片換另一張" alt="點擊圖片換另一張" /> （點擊圖片換另一張，分大小寫。）
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6" style="text-align:center;">
                                        <button id="btn_signup" class="btn btn-lg btn-primary">登入</button>
                                    </div>
                                    <div class="col-lg-6" style="text-align:center;">
                                        <button id="Button1" class="btn btn-lg btn-primary">我要註冊</button>
                                    </div>
                                </fieldset>
                            </div>
                        </div>
        ...
        <div id="proclaim" runat="server" class="row">
            <div class="col-md-12">
                ...
                <div id="footer_copyright" style="font-size:18px">版權所有貳伍零壹藝術行銷
                </div>
            </div>
        </div>
    </body>
