<%@ Page Language="C#" AutoEventWireup="true" CodeFile="symbolic.aspx.cs" Inherits="symbolic" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>2501 LOGO象徵</title>
...
<form></form>
   ...
   <ul class="nav navbar-nav" style="position:absolute";>
    ...
    <div class="row">
    <hr />
    <div id="arrow" class="col-xs-12 col-sm-12"><a href="./Default.aspx">首頁</a>＞<a href="./logbook.aspx">品牌記事</a>＞<a href="./symbolic.aspx">LOGO象徵</a></div>
    <hr />
    <div id="subtitle" class="col-xs-12 col-sm-2">
        <ul style="list-style-type:none;line-height:36px">
            <li><a href="./history.aspx">品牌故事</a></li>
