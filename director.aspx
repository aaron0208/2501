<%@ Page Language="C#" AutoEventWireup="true" CodeFile="director.aspx.cs" Inherits="director" %>
    ...
    <body>
        ...
        <div id="contents" runat="server">
            <hr />
            <div id="arrow" class="col-xs-12 col-sm-12"><a href="./Default.aspx">首頁</a>＞<a href="./news.aspx">最新消息</a>＞<a href="./director.aspx">導演</a>
            <hr />
            </div>
            <div id="inner" style="margin:0px auto;width:70%;">
            <div id="directname">蘇尚生2012CF
            </div>
            <div id="directtime">發布時間：<span id="diarytime">18/08/2014</span>
            </div>
            <div id="brandvideo" ><img src="./images/video.png" / style="width:100%">
            </div>
            <div id="maker" style="margin:0px auto;width:100%">
                <div id="production">影片製作Production：[25:01 Design T-shirt]
                </div>
                <div id="director">影片導演Director:蘇尚生
                </div>
                <div id="music">影片音樂Music：Red Shore Daniel
                <br /><a>https://www.facebook.com/RedShoeDaniel/</a>
                </div>
                <div id="actor">影片演員Actor:：孫彥翔
                </div>
                <div id="clothing">服裝提供Clothing Provided：[25:01 Design T-shirt]
                </div>
            </div>
            </div>
